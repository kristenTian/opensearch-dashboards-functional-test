...
describe('AD Host Health Historical results page', () => {
  ...
  before(() => {
    ...
    cy.getElementByTestId('createHostHealthSampleDetectorButton').click();
    cy.visit(AD_URL.DETECTOR_LIST);
    cy.contains('sample-host-health-detector').click();
